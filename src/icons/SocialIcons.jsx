// src/icons/SocialIcons.jsx
import React from 'react';
import { LinkedInIcon } from './LinkedInIcon';

export const SocialIcons = () => (
    <div className="flex justify-center space-x-6">
        <a href="https://www.instagram.com/telferbta" className="text-text-muted hover:text-accent transition-colors">
        ...
        <a href="https://www.linkedin.com/company/bta-uottawa/posts/?feedView=all" className="text-text-muted hover:text-accent transition-colors">
