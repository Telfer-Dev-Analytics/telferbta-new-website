...
export const Sponsors = () => {
    ...
    const sponsors = [
        { name: "CGI", logo: "src/assets/images/logos/CGI_Logo.png", needsBackground: false, tier: 'extra-large', link: 'https://www.cgi.com/' },
        { name: "EY", logo: "src/assets/images/logos/EY_Logo.png", needsBackground: false, tier: 'small', link: 'https://www.ey.com/' },
    ];
